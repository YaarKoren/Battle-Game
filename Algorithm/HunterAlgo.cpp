...
HunterAlgo::HunterAlgo(int tankId)
        : tankId_(tankId), currentDirection_(Direction::Up),
          turnsSinceLastUpdate_(0), isDirectionInitialized_(false) {} // Fixed initialization
...
bool HunterAlgo::isEnemyInLineOfFire(const Position& myPos,
                                     const vector<vector<char>>& grid,
...
bool HunterAlgo::isWallAhead(const Position& myPos,
